...
RAW = {
 "투썸플레이스": (43,55,.70,4100,2002,0), "탐앤탐스": (34,14,.80,4400,1999,0),
 "메가MGC커피": (74,29,.65,1500,2015,0), "파스쿠찌": (57,85,.60,4500,2002,0),
 "할리스": (36,18,.70,4500,1998,0),      "백억커피": (107,38,.85,1500,2018,0),
 "빽다방": (62,35,.75,2000,2006,0),       "매머드익스프레스": (55,18,.55,1200,2018,0),
 "드롭탑": (58,35,.78,4500,2009,0),       "엔제리너스": (27,34,.70,4500,2000,0),
 "컴포즈커피": (82,19,.80,1500,2014,0),   "더벤티": (89,45,.65,1500,2014,0),
 "하삼동커피": (77,32,.75,1500,2015,0),   "더리터": (47,18,.78,1500,2015,0),
 "이디야": (80,60,.75,3200,2001,0),       "감성커피": (89,68,.75,1900,2017,0),
 "커피베이": (89,50,.75,3900,2011,0),     "요거프레소": (32,15,.60,2300,2010,0),
 "커피에반하다": (63,5,.85,2000,2011,0),  "매머드커피": (60,30,.55,1200,2014,1),  # 레거시
}
