...
| 브랜드 | 총 메뉴 | 아메리카노 정가 | 가맹점 평균매출 |
|---|---|---|---|
| 투썸플레이스 | 98 | 4,700원 | 5.22억 |
| 백억커피 | 145 | 1,700원 | 4.33억 |
| 탐앤탐스 | 48 | 4,600원 | 3.85억 |
| 메가MGC커피 | 103 | 2,000원 | 3.63억 |
| 파스쿠찌 | 142 | 4,700원 | 3.48억 |
| 할리스 | 54 | 4,700원 | 3.44억 |
| 빽다방 | 97 | 2,000원 | 3.19억 |
| 엔제리너스 | 61 | 4,700원 | 2.76억 |
| 컴포즈커피 | 101 | 1,800원 | 2.65억 |
| 더벤티 | 134 | 2,000원 | 2.30억 |
| 이디야 | 140 | 3,200원 | 1.95억 |
| 요거프레소 | 47 | 2,400원 | 0.79억 |
| 커피베이 | 139 | 3,900원 | 0.79억 |

*(가격은 2025–2026년 아메리카노 정가 수준이며 포지셔닝 통제 변수로만 쓴다. 전체 19개 브랜드는 [`menusize_panel_v2.csv`](data/franchise/menusize_panel_v2.csv))*
...
| 아메리카노 정가 | [coffeehoneydeal 가격 비교](https://coffeehoneydeal.com/menu/%EA%B0%80%EA%B2%A9%EB%B9%84%EA%B5%90) (2026.09) + 일부 근사 | 포지셔닝 프록시 (2025–26년 수준) |
...
- 가격은 2025–26년 정가 수준의 근사값이다. 통제 변수로만 쓰고 계수 해석은 하지 않으며,
  이 값을 빼거나 바꿔도 핵심 결과(메뉴 수 ↔ 매출 r ≈ 0)는 변하지 않는다.
